...
public class Robot extends SampleRobot {
	...
	private SpeedController motor1 = new Talon(4); // initialize the motor as a
	private SpeedController motor2 = new Talon(5);											// Talon on channel 0
	...
	public void operatorControl() {
		while (isOperatorControl() && isEnabled()) {
			...
			// speed going forward)
//			System.out.println(SmartDashboard.getData("DB/Button 0"));
